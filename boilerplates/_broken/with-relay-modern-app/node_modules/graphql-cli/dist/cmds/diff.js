...
exports.command = 'diff <from> [to]';
exports.desc = 'Show a diff between two schemas';
...
function handler(context, argv) {
    return __awaiter(this, void 0, void 0, function () {
        var config, from, fromDesc, fromSchema, toSchema, toDesc, to, fromSDL, toSDL, diff, dangerousChanges, _i, dangerousChanges_1, change, breakingChanges, _a, breakingChanges_1, change;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    from = config.endpointsExtension.getEndpoint(argv.from);
                    fromDesc = argv.from + " (" + from.url + ")";
                    return [4 /*yield*/, from.resolveSchema()];
                case 1:
                    fromSchema = _b.sent();
                    if (!argv.to) return [3 /*break*/, 3];
                    to = config.endpointsExtension.getEndpoint(argv.to);
                    toDesc = argv.to + " (" + to.url + ")";
                    return [4 /*yield*/, to.resolveSchema()];
                case 2:
                    toSchema = _b.sent();
                    return [3 /*break*/, 4];
                case 3:
