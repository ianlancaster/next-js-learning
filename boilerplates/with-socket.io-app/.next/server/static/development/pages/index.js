...
class ChatOne extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(...args) {
    super(...args);
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "handleSubmit", event => {
      ...
      this.props.socket.emit('message.chat1', message); // add it to state and clean current input value
  ...
  static async getInitialProps({
    ...
    const response = await isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_3___default()('http://localhost:3000/messages/chat1');
  ...
  render() {
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("main", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(next_link__WEBPACK_IMPORTED_MODULE_2___default.a, {
      ...
      href: '/clone'
    }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("a", null, `Chat Two ${this.state.newMessage > 0 ? `( ${this.state.newMessage} new message )` : ''}`)), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("ul", null, this.state.messages.map(message => react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("li", {
      key: message.id
...
Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(ChatOne, "defaultProps", {
...
module.exports = __webpack_require__(/*! /Users/ilancaster/Desktop/next-js-learning/boilerplates/with-socket.io-app/pages/index.js */"./pages/index.js");
