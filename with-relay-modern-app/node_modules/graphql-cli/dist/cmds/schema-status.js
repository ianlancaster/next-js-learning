...
exports.desc = 'Show source and timestamp of the local schema file';
...
function handler(context, argv) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            schemaPath = context.getProjectConfig().schemaPath;
            ...
            maxLength = _(extensions).keys().map('length').max();
