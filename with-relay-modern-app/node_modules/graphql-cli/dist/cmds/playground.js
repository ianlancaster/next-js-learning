...
exports.command = 'playground [endpoint]';
exports.desc = 'Open interactive GraphQL Playground';
exports.builder = {
    port: {
        alias: 'p',
...
function handler(context, argv) {
    return __awaiter(this, void 0, void 0, function () {
        var config, endpoint, app, port, listener;
        return __generator(this, function (_a) {
            ...
            app.use('/playground', graphql_playground_middleware_express_1.default({ endpointUrl: '/graphql' }));
            port = argv.port || 3000;
